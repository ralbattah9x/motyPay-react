    ...
    return (
        <Layout>
            ...
            <div className="items-center justify-center bg-[#F8F8F8] h-screen ">
                <div className="flex pt-[200px] sm:pt-[20px] gap-[85px] sm:gap-[40px] justify-evenly sm:justify-end sm:items-end sm:flex-col md:pt-[100px]  md:pr-5 md:pl-5 xl:p-5 lg:p-5 lg:pt-[150px] xl:pt-[150px]">

                    <div className=" flex flex-col items-end justify-center gap-5 sm:p-4 ">
                        <div className="bg-lightGreen  h-[29px] w-[102px] content-center  rounded-[5px] ">
                        ...
                        <div className="flex flex-col items-end ">
                            <Text text={t("payment.page.subTitle1")} textFont="font-regTitle" textSize=" text-[18px] sm:text-[14px] md:text-[30px] lg:text-[25px] xl:text-[25px]" color="text-black" />
                            <Text text={t("payment.page.subTitle2")} textFont="font-regTitle" textSize="text-[18px] sm:text-[14px] md:text-[30px] lg:text-[25px] xl:text-[25px]" color="text-black" />
                        </div>

                        <div className=" flex  items-center sm:flex-col sm: gap-5 pt-10 sm:items-center ">

                            <Button buttonSize={"w-[153px] h-[47px] sm:w-[160px] border-lightGreen border-2"} textColor={"text-black"} text={t("home.page.learn.more")} color={"bg-grey"} onClick={() => (console.info)} />
